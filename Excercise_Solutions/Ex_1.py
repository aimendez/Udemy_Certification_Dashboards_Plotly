...
# EXCERCISE 1: Numpy/Pandas Practice
...
matrix = np.random.randint(1,100,size=(100,5))
...
matrix_2 = np.random.randint(0, 100, size=(50,4))
cols = ['A','B','C','D']
df_2 = pd.DataFrame(matrix_2, columns = cols)
